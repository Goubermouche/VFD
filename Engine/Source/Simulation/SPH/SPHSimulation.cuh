...
namespace fe {
	extern "C" {
		...
		void SPHIntegrate(unsigned int oldPositionVBO, unsigned int newPositionVBO, glm::vec4* oldVelocity, glm::vec4* newVelocity, int particleCount);
		...
		/// <param name="particleCount">Particle count.</param>
		void SPHCalculateHash(unsigned int positionVBO, glm::uvec2* particleHash, int particleCount);
		...
		void SPHReorder(unsigned int oldPositionVBO, glm::vec4* oldVelocity, glm::vec4* sortedPosition, glm::vec4* sortedVelocity,
		...
		/// <param name="particleCount">Particle count.</param>
		/// <param name="cellCount">Cell count.</param>
		void SPHCollide(unsigned int positionVBO, glm::vec4* sortedPosition, glm::vec4* sortedVelocity,
