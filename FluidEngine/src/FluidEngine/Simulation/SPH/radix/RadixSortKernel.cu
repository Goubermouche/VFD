...
namespace fe {
	...
	__global__ void RadixSum(KeyValuePair* pData, uint elements, uint elements_rounded_to_3072, uint shift) {
		...
		while (pos < end)
		{
			...
			if (tmod == 0 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 1 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 2 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 3 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 4 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 5 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 6 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 7 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 8 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 9 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 10 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 11 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 12 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 13 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 14 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
			if (tmod == 15 && pos < elements)	sRadixSum[ppos]++;	__syncthreads();
	...
	__global__ void RadixAddOffsetsAndShuffle(KeyValuePair* pSrc, KeyValuePair* pDst, uint elements, uint elements_rounded_to_3072, int shift)
	{
		...
		while (pos < end)
		{
			...
			uint ppos = p + tpos;
			if (tmod == 0 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 1 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 2 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 3 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 4 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 5 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 6 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 7 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 8 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 9 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 10 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 11 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 12 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 13 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 14 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
			if (tmod == 15 && pos < elements) { index = sRadixSum[ppos]++;	pDst[index] = kvp; }	__syncthreads();
